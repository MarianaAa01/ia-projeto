...
if __name__ == "__main__":
    ...
    print("\n=== TESTES ===")
    # Exemplo: valores adjacentes da posição (1,1)
    print("Valores adjacentes a (1,1):", board.adjacent_values(1, 1))

    # Exemplo: posições adjacentes de (1,1)
    print("Posições adjacentes a (1,1):", board.adjacent_positions(1, 1))
